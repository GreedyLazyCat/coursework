...
.loadqueue-item-info__path {
    font-size: 12px;
    color: var(--md-sys-color-on-surface-variant);
}

.loadqueue-item-info__name {
    font-size: 14px;
    font-weight: 600;
}
