...
async function onSubmit() {
    ...
    if (passwordHasError.value || usernameHasError.value || repeatPasswordHasError.value || emailHasError.value) {
        return
    }
    try {
        ...
        <div class="signup-center-group">
            <div class="signup-card">
                ...
                <form action="" @submit.prevent="onSubmit">
                    ...
                    <CuraInput placeholder="Email" name="password" type="text" v-model.trim="email"
